...
![](media/chapter_aov.jpg){.rounded fig-alt="Decorative chapter image showing a milkweek beetle on a plant."}

> If your data are taken from discrete groups (e.g., treatments), then we are generally testing the equality of each group mean.

## Lecture Materials

::: {.content-visible when-format="html"}

Below are the slides that are used in the lecture component of this topic. You can cycle through them using the cursor arrows or open the [online version](https://dyerlabteaching.github.io/Analysis-of-Variance/slides.html#/title-slide){.external target="_blank"} in a new browser window.

```{=html}
<iframe src="https://dyerlabteaching.github.io/Analysis-of-Variance/slides.html#/title-slide" width="100%" height="400px"></iframe>
```
:::

::: {.content-visible unless-format="html"}
> **Lecture Slides:** Available interactively in the [online version](https://dyerlabteaching.github.io/Analysis-of-Variance/slides.html#/title-slide)

![Lecture Slides](media/slides_aov.png)
:::
