...
![](media/chapter_ordination.jpg){.rounded fig-alt="Decorative chapter image of a small mamallaria cactus in bloom in Baja California."}
...
Below are the slides that are used in the lecture component of this topic. You can cycle through them using the cursor arrows or open the [online version](https://dyerlabteaching.github.io/Ordination/slides.html#/title-slide){.external target="_blank"} in a new browser window.

```{=html}
<iframe src="https://dyerlabteaching.github.io/Ordination/slides.html#/title-slide" width="100%" height="400px"></iframe>
```
:::

::: {.content-visible unless-format="html"}
> **Lecture Slides:** Available interactively in the [online version](https://dyerlabteaching.github.io/Ordination/slides.html#/title-slide)

![Lecture Slides](media/slides_ordination.png)
:::
