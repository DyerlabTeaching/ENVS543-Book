...
![](media/chapter_joins.jpg){.rounded fig-alt="Decorative chapter image of a flooeded forest."}

> Effectively storing data often requires the use of several data frames to reduce redundancy.  In this short chapter, we will cover how to join data from multiple sources.

## Lecture Materials

::: {.content-visible when-format="html"}

Below are the slides that are used in the lecture component of this topic. You can cycle through them using the cursor arrows or open the [online version](https://dyerlabteaching.github.io/Joins/slides.html#/title-slide){.external target="_blank"} in a new browser window.

```{=html}
<iframe src="https://dyerlabteaching.github.io/Joins/slides.html#/title-slide" width="100%" height="400px"></iframe>
```
:::

::: {.content-visible unless-format="html"}
> **Lecture Slides:** Available interactively in the [online version](https://dyerlabteaching.github.io/Joins/slides.html#/title-slide)

![Lecture Slides](media/slides_joins.png)
:::
...
![Example data table structure](media/data_table_structure.jpg)
...
![Right Join](media/right_join.jpg)
...
![Outer Join](media/outer_join.jpg)
...
![Inner Join](media/inner_join.jpg)
