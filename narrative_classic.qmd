...
![](media/chapter_classic.jpg){.rounded fig-alt="Decorative chapter image showing an orange newt on the forest floor."}
...
Below are the slides that are used in the lecture component of this topic. You can cycle through them using the cursor arrows or open the [online version](https://dyerlabteaching.github.io/Graphics-That-Do-Not-Suck/slides_classic.html#/title-slide){.external target="_blank"} in a new browser window.

```{=html}
<iframe src="https://dyerlabteaching.github.io/Graphics-That-Do-Not-Suck/slides_classic.html#/title-slide" width="100%" height="400px"></iframe>
```
:::

::: {.content-visible unless-format="html"}
> **Lecture Slides:** Available interactively in the [online version](https://dyerlabteaching.github.io/Graphics-That-Do-Not-Suck/slides_classic.html#/title-slide)

![Lecture Slides](media/slides_classic.png)
:::
...
![The three species of iris in the default data set.](media/iris_species.jpg)
...
![ColorBrewer Site](media/colorbrewer_site.jpg)
