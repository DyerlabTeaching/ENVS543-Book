...
<p align="center">
<img src="media/DataAnimation.gif" alt="multiple data sets with the exact same mean, standard deviation, and correlation (to 2 decimal points) but very different distributions."/>
</p>

## ENVS 543: Environmental Data Literacy Fall Semesters
...
<img src="media/dyer.png" align="right" alt="Dr. Rodney Dyer"/>
...
<img src="media/workflow.png" alt="A schematic of the general data analysis workflow showing collecting data entering into a circling of visualization to tranformation to model and back to visualization.  After that cycle finishes, eventually we exit this repeating cycle to produce some kind of communication of the results to our audience." />
...
We will be using the [Positron IDE](https://positron.posit.co/) to write code, analysis, and narrative using markdown.  We will also be integrating the **envsAI-TA** chatbot interface for Positron, which has been trained on *all* course content and will serve as a generic AI assistant for you in this course.
...
Students should visit VCU's [Syllabus Information for Students](http://go.vcu.edu/syllabus) page and review all syllabus statement information. The full university syllabus statement includes information on safety, registration, the VCU Honor Code, student conduct, withdrawal, and more.
