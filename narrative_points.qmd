...
![](media/chapter_points.jpg){.rounded fig-alt="Decorative chapter image of the desert landscape in Baja California with cacti and boojum trees."}
...
Below are the slides that are used in the lecture component of this topic. You can cycle through them using the cursor arrows or open the [online version](https://dyerlabteaching.github.io/Spatial-Points/slides.html#/title-slide){.external target="_blank"} in a new browser window.

```{=html}
<iframe src="https://dyerlabteaching.github.io/Spatial-Points/slides.html#/title-slide" width="100%" height="400px"></iframe>
```
:::

::: {.content-visible unless-format="html"}
> **Lecture Slides:** Available interactively in the [online version](https://dyerlabteaching.github.io/Spatial-Points/slides.html#/title-slide)

![Lecture Slides](media/slides_points.png)
:::
...
<center>
![Baja California](media/baja_california.jpg)
</center>
...
<center>
![Azequidistant](media/azimuthal_projection.jpg)
</center>
...
<center>![Cylindrical Projection](media/cylindrical_projection.jpg)</center>
...
<center>![Conic Projection](media/conic_projection.jpg)</center>
...
[![epsg.io](media/epsg_io.jpg)](https://epsg.io)
...
::: {layout-ncol=2}
![Araptus attenuatus](media/araptus_attenuatus.jpg)

![Euphorbia lomelii](media/euphorbia_lomelii.jpg)
:::
...
::: {.content-visible unless-format="html"}
![Araptus Beetle Sampling Sites - Interactive map available in online version](media/map_points_leaflet.png)
:::
