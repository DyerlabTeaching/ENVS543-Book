...
![](media/chapter_correlation.jpg){.rounded fig-alt="Decorative chapter image of an old field and fence in Virginia."}
...
Below are the slides that are used in the lecture component of this topic. You can cycle through them using the cursor arrows or open the [online version](https://dyerlabteaching.github.io/Correlation/slides.html#/title-slide){.external target="_blank"} in a new browser window.

```{=html}
<iframe src="https://dyerlabteaching.github.io/Correlation/slides.html#/title-slide" width="100%" height="400px"></iframe>
```
:::

::: {.content-visible unless-format="html"}
> **Lecture Slides:** Available interactively in the [online version](https://dyerlabteaching.github.io/Correlation/slides.html#/title-slide)

![Lecture Slides](media/slides_correlation.png)
:::
...
![Various roles played by the American actor, Mr. Nicolas Cage.](media/NicolasCage.png)
...
```{r}
cor.test( df$`Nicolas Cage Movies`, df$`Drowning Deaths in Pools`) -> fit.cage
fit.cage
```

We do in fact see a significant (P = `r format( fit.cage$p.value, digits=3) `) relationship.  
...
![*Figure 1: Data and associated correlation statistics.*](media/correlation_data.jpg)
