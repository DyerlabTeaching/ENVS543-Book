...
![](media/chapter_ggplot.jpg){.rounded fig-alt="Decorative chapter image of leaves turning colors for an ornamental plant."}
...
Below are the slides that are used in the lecture component of this topic. You can cycle through them using the cursor arrows or open the [online version](https://dyerlabteaching.github.io/Graphics-That-Do-Not-Suck/slides.html#/title-slide){.external target="_blank"} in a new browser window.

```{=html}
<iframe src="https://dyerlabteaching.github.io/Graphics-That-Do-Not-Suck/slides.html#/title-slide" width="100%" height="400px"></iframe>
```
:::

::: {.content-visible unless-format="html"}
> **Lecture Slides:** Available interactively in the [online version](https://dyerlabteaching.github.io/Graphics-That-Do-Not-Suck/slides.html#/title-slide)

![Lecture Slides](media/slides_ggplot.png)
:::
...
![base plot in R](media/base_plot_r.jpg)
...
![The Grammar of Graphics by Leland Wilkinson](media/grammar_of_graphics.jpg)
...
![The iris data](media/iris_species.jpg)
