...
![](media/chapter_markdown.jpg){.rounded fig-alt="Decorative chapter image showing a closeup of a dogwood blossum and small dogwood beetle."}
...
Below are the slides that are used in the lecture component of this topic. You can cycle through them using the cursor arrows or open the [online version](https://dyerlabteaching.github.io/Markdown/slides.html#/title-slide){.external target="_blank"} in a new browser window.

```{=html}
<iframe src="https://dyerlabteaching.github.io/Markdown/slides.html#/title-slide" width="100%" height="400px"></iframe>
```
:::

::: {.content-visible unless-format="html"}
> **Lecture Slides:** Available interactively in the [online version](https://dyerlabteaching.github.io/Markdown/slides.html#/title-slide)

![Lecture Slides](media/slides_markdown.png)
:::
...
![Conversion Formats](media/conversion_formats.jpg)
...
| Markdown | Rendered As |
|-----------------------------------|-------------------------------------|
| \[SLSS\](https://slss.vcu.edu) | [SLSS](https://slss.vcu.edu) |
...
![Option buttons for each chunk include a quick menu for optoins (gear), the ability to run all the chunks above this one (triangle and line button in the middle), and run this particular chunk (play button).](media/chunk_options.jpg)
