...
![](media/chapter_datatypes.jpg){.rounded fig-alt="Decorative chapter image showing a termpreate forest in Virginia during the fall with golden leaves."}

> When we work with an analysis language, we need to be very precise about how we represent the data we collect.  R is a general analysis language and has a wide range of native data types and can easily be expanded using the package system.

## Lecture Materials

::: {.content-visible when-format="html"}

Below are the slides that are used in the lecture component of this topic. You can cycle through them using the cursor arrows or open the [online version](https://dyerlabteaching.github.io/Basic-Data-Types/slides.html#/title-slide){.external target="_blank"} in a new browser window.

```{=html}
<iframe src="https://dyerlabteaching.github.io/Basic-Data-Types/slides.html#/title-slide" width="100%" height="400px"></iframe>
```
:::

::: {.content-visible unless-format="html"}
> **Lecture Slides:** Available interactively in the [online version](https://dyerlabteaching.github.io/Basic-Data-Types/slides.html#/title-slide)

![Lecture Slides](media/slides_datatypes.png)
:::
